...
function woocommerce_after_shop_loop_item_title_short_description() {
	...
	?>
	<div class="text2" itemprop="description">
...
add_action( 'woocommerce_shop_loop_item_title', 'custom_product_category_cat', 6 );
function custom_product_category_cat(){
	global $post;
	...
	echo "<div class='product_title entry-cat'>".$cat." <span> </span></div>";
}
