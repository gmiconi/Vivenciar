...
if ( ! function_exists( 'engitech_posted_in' ) ) :
    ...
    function engitech_posted_in() {
        ...
        if ( ! empty( $categories ) ) {
            echo '<div class="post-cat"><span class="posted-in">' . $categories[0]->name . '</span></div>'; // WPCS: XSS OK.
...
if ( ! function_exists( 'engitech_single_post_nav' ) ) :
    ...
    function engitech_single_post_nav(){
        ...
        if ( get_previous_post() ) {
            ...
            previous_post_link( '%link', 'Conheça também <h6>'.$ptitle.'</h6>' );
        ...
        if ( get_next_post() ) {
            ...
            next_post_link( '%link', 'Conheça também <h6>'.$ntitle.'</h6>' );
